function init()
    ...
    yg.asset.loadVertFragShader("diff", "a//_default.vert", "a//_diffusecolor.frag")
    yg.asset.loadVertFragShader("simple", "a//_default.vert", "a//_simplecolor.frag")
    yg.asset.loadVertFragShader("tex", "a//_default.vert", "a//_diffusetex.frag")
    yg.asset.loadGeometry("cube", "a//box.obj", "a//box.mtl")
    yg.asset.loadGeometry("sphere_outside", "a//_sphere_outside.obj")
    yg.asset.loadGeometry("grid", "a//_grid.obj")
    yg.asset.loadGeometry("cylinder", "a//_cylinder.obj")
